...
export default function CalcolatoreContoTermico() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-orange-100">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-red-500 to-orange-500 text-white pt-6 pb-12 sm:pt-8 sm:pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-4">
              ...
              <span className="font-semibold">Conto Termico 2.0</span>
            </div>
